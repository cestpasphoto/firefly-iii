  ...
  methods: {
    ...
    addTransactionToArray: function addTransactionToArray(e) {
      ...
      if (this.transactions.length === 1) {
        ...
        // set first date.
        var today = new Date();
        this.transactions[0].date = today.getFullYear() + '-' + ("0" + (today.getMonth() + 1)).slice(-2) + '-' + ("0" + today.getDate()).slice(-2) + 'T00:00';
